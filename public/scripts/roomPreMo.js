//This is a page for the mobile elements on the page.
//It serves largely similar functionality to the script for the main, but the
//jquery selectors select the mobile elements instead
